...
RAW_QUEUE_MAXSIZE: int = Field(default=200, gt=0)
SPEECH_QUEUE_MAXSIZE: int = Field(default=50, gt=0)
...
RAW_QUEUE_MAXSIZE = settings.RAW_QUEUE_MAXSIZE
SPEECH_QUEUE_MAXSIZE = settings.SPEECH_QUEUE_MAXSIZE
